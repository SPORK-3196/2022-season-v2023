...
/** A ThreeCargoAuto command that uses the shooter, drivetrain, intake, index, and climber subsystems. */
    ...
    public ThreeCargoAuto(Drivetrain drivetrain, Shooter shooter, Intake intake, Index index, Climber climber) {
      super(
        ...
        new DelayedIndexConditional(index, 1)
          .alongWith(
            new DriveToPickupAim(drivetrain, index, shooter, climber, intake, 3, -0.15).until(index::getIntakeSensor)),
