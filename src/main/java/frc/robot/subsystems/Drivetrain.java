...
public class Drivetrain extends SubsystemBase {
  ...
  */
  ...
  private DifferentialDriveOdometry drivetrain_odometry = new DifferentialDriveOdometry(new Rotation2d(getGyroHeadingRads()), 0, 0, robot_pose);
  ...
  public void resetOdometry(Pose2d pose) {
    resetEncoders();
    drivetrain_odometry.resetPosition(new Rotation2d(getGyroHeadingRads()), 0, 0, pose);
  }
