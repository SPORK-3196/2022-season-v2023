...
public final class GlobalVars {
    ...
    public static final class Field {
        public static GenericEntry MatchTimeEntry = AI_TAB
    ...
    public static final class Vision {
        ...
        public static GenericEntry AI_DISTANCE_ENTRY = AI_TAB
    ...
    public static final class Drivetrain { 
        ...
        public static GenericEntry DT_AutoPEntry = DT_TAB.add("Proportional Constant", 0).getEntry();

        public static GenericEntry DT_FrontLeftEntry = DT_TAB.add("Front Left Power", 0).getEntry();
        public static GenericEntry DT_rearLeftEntry = DT_TAB.add("rear Left Power", 0).getEntry();
        public static GenericEntry DT_FrontRightEntry = DT_TAB.add("Front Right Power", 0).getEntry();
        public static GenericEntry DT_rearRightEntry = DT_TAB.add("rear Right Power", 0).getEntry();

        public static double DT_PowerConstant = 1.0;
        public static GenericEntry DT_PowerConstantEntry = DT_TAB
            .addPersistent("Drive Power Percentage", 55)
            .withWidget(BuiltInWidgets.kNumberSlider)
            .withProperties(Map.of("min", 0, "max", 100))
            .getEntry();

        public static GenericEntry DT_MusicPlaying = DT_TAB.add("Music Playing", false)
        ...
        public static GenericEntry DT_TargetOffsetAngle = DT_TAB.add("Target Offset", 0).getEntry();
    }
    ...
    public static final class Index {
        ...
        public static GenericEntry CargoCounter_Entry = SENSOR_TAB.add("# Cargo", 0).getEntry();

        public static GenericEntry intakeSensor_Entry = SENSOR_TAB.add("Intake Sensor", false).getEntry();
        public static GenericEntry midSensor_Entry = SENSOR_TAB.add("Middle Sensor", false).getEntry();
        public static GenericEntry topSensor_Entry = SENSOR_TAB.add("Top Sensor", false).getEntry();
        
        public static GenericEntry SN_BALL_COUNTER = SENSOR_TAB
            .add("Cargo Counter", 0)
    ...
    public static final class Shooter{
        ...
        public static GenericEntry SH_SHOOTER_RPM_Entry = SH_TAB
            .add("Shooter RPM", 0)
            .withWidget(BuiltInWidgets.kDial)
